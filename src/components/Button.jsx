...
function Button(props) {
  return (
    <span className="relative inline-flex items-center justify-start overflow-hidden font-medium transition-all bg-indigo-100 rounded hover:bg-white group py-1.5 px-2.5 bg-opacity-70 cursor-pointer">
